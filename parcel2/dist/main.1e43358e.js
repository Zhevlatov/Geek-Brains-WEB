...
exports.Zone = Zone;
},{}],"src/datecalc.js":[function(require,module,exports) {
"use strict";
...
exports.diffToHtml = void 0;
var _luxon = require("luxon");
function diffDates(firstDate, secondDate) {
  firstDate = _luxon.DateTime.fromISO(firstDate);
  secondDate = _luxon.DateTime.fromISO(secondDate);
  if (firstDate > secondDate) secondDate = [firstDate, firstDate = secondDate][0];
  return secondDate.diff(firstDate, ['years', 'months', 'days']).toObject();
}
var diffToHtml = function diffToHtml(diff) {
  return " \n    <span> \n        ".concat(diff.years ? 'Лет: ' + diff.years : '', "\n        ").concat(diff.months ? 'Месяцев: ' + diff.months : '', " \n        ").concat(diff.days ? 'Дней: ' + diff.days : '', " \n    </span> \n");
};
exports.diffToHtml = diffToHtml;
},{"luxon":"node_modules/luxon/build/cjs-browser/luxon.js"}],"src/utils.js":[function(require,module,exports) {
"use strict";
...
var formatError = function formatError(text) {
  return "\n<span style=\"color: red;\">\n    ".concat(text, " \n</span> \n");
};
exports.formatError = formatError;
},{}],"src/play_sound.js":[function(require,module,exports) {
"use strict";
...
var _play_sound = require("./play_sound.js");
...
//----------------------------------------------------------------------------------
var timerForm = document.getElementById("timer");
var timerRemain = document.getElementById("timer_remain");
var timerStart = document.getElementById("start");
var timerStop = document.getElementById("stop");
var sound = new Audio('https://interactive-examples.mdn.mozilla.net/media/cc0-audio/t-rex-roar.mp3');
...
function timerGO(event) {
  event.preventDefault();
  var time = event.target.elements.time;
  time = time.value.split(':');
  time = time[0] * 1000 * 60 * 60 + time[1] * 1000 * 60;
  setTimeout(_play_sound.timer, time, sound);
  melting = setInterval(function () {
    ...
    timerRemain.innerText = "".concat(hours, " \u0447\u0430\u0441\u043E\u0432, ").concat(minutes, " \u043C\u0438\u043D\u0443\u0442, ").concat(seconds, " \u0441\u0435\u043A\u0443\u043D\u0434");
    time = time - 1000;
  }, 1000);
}
function timerSTOP() {
...
},{"./datecalc.js":"src/datecalc.js","./utils.js":"src/utils.js","./play_sound.js":"src/play_sound.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
